...
Android input events feed client shortcuts and the active EmuHub player. Select+Start and held L3+R3 are reserved client chords in the inspected implementation.
